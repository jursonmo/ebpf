...
#ifdef VMLINUX_H
#include "../../vmlinux_headers/6.8.0.vmlinux.h"
...
#define DNS_PORT         53
#define MARK_NO_REDIRECT 54  //为了表明这个mark是绕过dns重定向的mark, 所以marK改成54;iptables -t mangle -I PREROUTING -p udp --dport 53 -m mark --mark 54 -j ACCEPT
